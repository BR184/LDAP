...
```
cd existing_repo
git remote add origin http://10.0.100.25/developer_experience_platform/ldap.git
git branch -M main
...
- [ ] [Set up project integrations](http://10.0.100.25/developer_experience_platform/ldap/-/settings/integrations)

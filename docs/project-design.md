...
- 登录字段：固定为 `uid`
- 标准用户过滤器：`(&(objectClass=inetOrgPerson)(uid={login})(employeeType=ENABLED))`
...
�������ڸ����ĵ������ڡ�����Ա��������̶�Ϊ `123456` ����ǰ�˵���չʾ�������롱��ԭ����ơ��Ա��θ���������������·ͳһ����Ϊ����� 6 λ�������� + LDAP ���� + �ʼ�֪ͨ��������

#### 16.19.1 ���Ŀ��

- ����Ա��������ʱ��ϵͳ������� 6 λ�������롣
- ������д�� LDAP �󣬲��ٷ���ǰ��ҳ�棬����ͨ���ʼ����͸��û���
- ��¼ҳ�������������롱��ڣ��û�ֻ�����û������ɴ���ͬһ�������������̡�
- ��������ӿڶ���ͳһ���ع̶��ɹ��İ�������й¶�˺Ŵ����ԡ�
- �������óɹ������ `tokenVersion`��ʹ���е�¼̬ʧЧ��
- ��ǰ�׶β�����������Ч�ڣ�Ҳ�������״ε�¼ǿ�Ƹ��ܡ�
...
1. ����Ա���� `PUT /api/v1/users/{id}/password/reset`
2. ���У�������Ȩ��
3. ��ȡĿ���û���У���������
4. ������� 6 λ��������
5. ���� LDAP ִ����������
...
1. �û����� `POST /api/v1/auth/password/forgot`
2. ����������� `username`
3. ��˻����û����Ϳͻ��� IP ִ������
4. ���û����ڡ�״̬���������������䣬��ִ������������ɡ�LDAP ���ܡ�`tokenVersion` �������ʼ�����
5. �����ڲ��Ƿ�ɹ�������ͳһ���ع̶��ɹ��İ���`���˺���Ϣ��Ч��ϵͳ�ѷ��������ʼ�����ע�����`

#### 16.19.3 �ʼ��밲ȫԼ��

- �ʼ����⽨��Ϊ��`ͳһ���ݹ���ƽ̨��������֪ͨ`
- �ʼ����Ĺ̶�������`��ǰ����������Ϊ��${password}���뾡���޸����룡`
- �ʼ����Ĳ�����ʾ��`��Ǳ��˲�������������ϵ����Ա��`
- ǰ�ˡ��ӿ���Ӧ����־����������������ģ�ֻ���ʼ���������Я��������
- ��������ӿڲ��õ�ʵ���ڴ��������ԣ�
  - ͬһ�û��� 5 �����ڽ���������һ��
  - ͬһ IP 5 ����������������� 10 ��
- �������볬��ʱ��������ͳһ�ɹ��İ���������ִ�� LDAP ���ܺ��ʼ�����
...
- ҵ������ͨ�� `app.password-reset.*` �����ʼ����⡢�����˺���������
- SMTP ��������ͨ����׼ `spring.mail.*` ����
- ���ʼ�����δ���ã�����Ա��������ʱӦ��ʽ������������������Է���ͳһ�ɹ��İ������ڲ���¼ʧ�����

#### 16.19.6 ��������޶���2026-04-24 ���ε�����

�������ڸ��� 16.19 ����ǰ������Ա���������ͨ���ʼ����͡������˵�����������¹����������ò��Ե���Ϊ��������·����

- ����Ա�򳬼�����Ա���û�����������������������ʱ��ϵͳ��Ŀ���û�����ֱ������Ϊ�̶�Ĭ������ `123456`
- �����̨���ò��������ʼ����ͣ�Ҳ��Ҫ��Ŀ���û�������������
- �û������ڵ�¼ҳ������������롱ʱ����Ȼ�ߺ����������������ʼ�֪ͨ����
- ��������ӿڼ���ά��ͳһ�ɹ��İ����������ԣ�����¶�˺�״̬
...
1. `PUT /api/v1/users/{id}/password/reset`
   - �������Ա / ��������Ա
   - �̶�����Ϊ `123456`
   - ���� `tokenVersion`
   - �������ʼ�
